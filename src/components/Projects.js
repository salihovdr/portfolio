...
export default function Projects(){
	return (
		<div className='container' id='projects'>
			<div className='row'>
				<h2 className='col-12 section-heading'>PROJECTS</h2>
				<ProjectItem 
					img={'https://s3.amazonaws.com/donics/Screen+Shot+2018-09-14+at+17.18.41.png'} 
					alt={'Privet -- app for learning Russian'}
					description={'App for learning Russian vocabulary. Privet uses a Spaced Repetition algorithm to speed up your learning. As you answer words correctly, the app will show you those words less frequently. If you guess the wrong answer, you will be given more opportunities to practice that word. Learning has never been easier!'}
